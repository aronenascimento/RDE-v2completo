  ...
  useEffect(() => {
    ...
    const scriptContent = `
      ...
      window._show_thank_you = function(id, message, trackcmp_url, email) {
          ...
          if (form) form.querySelector('._form-content').style.display = 'none';
          if (thank_you) {
          ...
          if (typeof _load_script === 'function' && trackcmp_url) {
      ...
      window._show_unsubscribe = function(id, message, trackcmp_url, email) {
          ...
          if (form) form.querySelector('._form-content').style.display = 'none';
          if (unsub) unsub.style.display = 'block';
      ...
      window._show_error = function(id, message, html) {
          ...
          err.className = '_error-inner _form-error _no-arrow';
          var wrapper = document.createElement('div');
          wrapper.className = '_form-inner _show-be-error';
      ...
      window._show_pc_confirmation = function(id, header, detail, show, email) {
          ...
          if (pc_confirmation.style.display === 'none') {
              ...
              if (form) form.querySelector('._form-content').style.display = 'inline';
          ...
          if (hideButton) {
            hideButton.addEventListener('click', function() {
              ...
              cacheBuster.searchParams.set('v', new Date().getTime().toString());
      ...
      (function() {
          ...
          var create_tooltip = function(elem, text) {
              ...
              if (elem.type != 'radio' && (elem.type != 'checkbox' || elem.name === 'sms_consent')) {
                  ...
                  tooltip.className = '_error-inner _no-arrow';
